...
export default class DeduplicatedJobRequiresMinimumDelay extends Error {
  ...
  public override get message() {
    ...
    return `
A delayed background job was given the \`jobId\` ${JSON.stringify(this.jobId)}, but a delay too short to deduplicate with (got \`delaySeconds\`: ${String(this.delaySeconds)}).
